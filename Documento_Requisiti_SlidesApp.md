...
- gestione dati persistente tramite database;
- interfaccia web con visualizzazione dinamica lato server (Jinja2);
...
L'ispirazione viene da strumenti come PowerPoint o Google Slides, ma con un approccio volutamente semplificato: nessun editor visuale, tutto il rendering avviene lato server tramite Flask e Jinja2.
...
- Fornire un'interfaccia web **semplice e accessibile**.
